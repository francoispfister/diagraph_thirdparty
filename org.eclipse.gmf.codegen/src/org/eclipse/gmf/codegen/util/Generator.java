...
public class Generator extends GeneratorBase implements Runnable {
	...
	private void generateExternalizationSupport() throws UnexpectedBehaviourException, InterruptedException {
		String packageName = myEditorGen.getEditor().getPackageName(); //FP140616xxx
	...
	private void generateExternalizationSupport_nu() throws InterruptedException { //UnexpectedBehaviourException,
		...
		try {
			...
			throw new RuntimeException("exception in generateExternalizationSupport "+e.toString()); //FP140616voir2
		}
		/*
