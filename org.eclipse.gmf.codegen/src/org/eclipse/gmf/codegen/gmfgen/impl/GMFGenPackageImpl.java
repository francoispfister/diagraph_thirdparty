...
public class GMFGenPackageImpl extends EPackageImpl implements GMFGenPackage {
	 ...
	 * @generated
	 */
	public EReference getGenEditorGenerator_Extension() {
        return (EReference)getGenEditorGenerator().getEStructuralFeatures().get(24);
	}
	 ...
	 * @generated
	 */
	public EReference getGenEditorGenerator_StyleExtension() {
        return (EReference)getGenEditorGenerator().getEStructuralFeatures().get(25);
	}
